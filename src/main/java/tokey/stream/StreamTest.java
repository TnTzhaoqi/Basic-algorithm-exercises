...
import tokey.stream.util.Status;
import tokey.stream.util.User;
...
public class StreamTest {
    ...
    public void testMap() {
        ...
        Stream<Character> stream2 = list.stream().flatMap(StreamTest::filterCharacter);
